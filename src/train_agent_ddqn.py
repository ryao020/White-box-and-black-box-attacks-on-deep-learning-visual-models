...
def main():
    ...
    # save the model
    # torch.save(policy_net.state_dict(), 'policy_net_ddqn1.pth')
    torch.save(policy_net.state_dict(), 'policy_net_ddqn2.pth')

    plt.plot(total_rewards)
    # plt.savefig('training_progress_ddqn1.png')
    plt.savefig('training_progress_ddqn2.png')
